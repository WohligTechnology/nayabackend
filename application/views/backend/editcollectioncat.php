<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Edit collectioncat</h4>
</div>
</div>
<div class="row">
<form class='col s12' method='post' action='<?php echo site_url("site/editcollectioncatsubmit");?>' enctype= 'multipart/form-data'>
